              ...
              @foreach ($tikets as $tiket)
                <tr>
                  ...
                  <td class="text-center" style="width: 120px">
                    @if ($tiket->teknisi_id)
                      <a href="{{ url('client/tiket/obrolan/' . $tiket->id) }}" class="btn btn-info btn-sm">
                        Obrolan
                        @php
                        ...
                        @if ($obrolan)
                          @php
                            $detail_obrolans = \App\Models\DetailObrolan::where([['obrolan_id', $obrolan->id],
                            ['pengirim_id', '!=', auth()->user()->id], ['is_read', false]])->get();
                          @endphp
                      ...
                      <div class="modal-body">
                        ...
                        @if ($tiket->teknisi_id)
                          ...
                          <p class="text-wrap">
                            ...
                            <br>
                            {{ date(
                                strtotime($tiket->tanggal_pengerjaan . ' + ' . $tiket->produk->sublayanan->layanan->level->lama . ' days'),
                            ) }}
                          </p>
                        @endif
                      </div>
