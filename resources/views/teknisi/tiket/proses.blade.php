              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="modalToggleLabel">Selesaikan Tiket</h5>
                  ...
                  <div class="modal-body">
                    ...
                    <p class="text-wrap">
                      ...
                      <br>
                      <span class="badge bg-primary">{{ $tiket->status }}</span>
                    </p>
                  </div>
                  <div class="modal-footer">
                    ...
                    <a href="{{ url('teknisi/tiket/konfirmasi/' . $tiket->id) }}" class="btn btn-primary">
                      Selesaikan
                    </a>
                  </div>
                </div>
