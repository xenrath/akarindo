              ...
              <div class="col-md-6">
                <div class="form-group mb-3">
                  ...
                  <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" id="nama"
                    value="{{ old('nama', $produk->nama) }}" autocomplete="off" autofocus />
                  @error('nama')
              ...
              <div class="col-md-6">
                <div class="form-group mb-3">
                  ...
                  <select class="form-select @error('user_id') is-invalid @enderror" id="user_id" name="user_id">
                    ...
                    <option value="{{ $user->id }}" {{ old('user_id', $produk->user_id)==$user->id ? 'selected' : null
                      }}>{{ $user->nama
                      }}</option>
                    @endforeach
                  </select>
              ...
              <div class="col-md-6">
                <div class="form-group mb-3">
                  ...
                  <input type="text" class="form-control @error('url') is-invalid @enderror" name="url" id="url"
                    value="{{ old('url', $produk->url) }}" autocomplete="off" />
                  @error('url')
                  <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
