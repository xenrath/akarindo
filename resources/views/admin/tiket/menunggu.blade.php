          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center">
                <button type="button" class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#modal-konfirmasi">
                  Proses
                </button>
              </td>
            </tr>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer justify-content-between">
                    ...
                    <a href="{{ url('admin/tiket/konfirmasi_proses/' . $tiket->id) }}" class="btn btn-primary">Proses</a>
                  </div>
                </div>
              </div>
            </div>
