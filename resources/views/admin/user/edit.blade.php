          ...
          <div class="col-md-6">
            <div class="form-group mb-3">
              ...
              <select class="form-select" id="role" name="role">
                ...
                <option value="cs" {{ old('role', $user->role)=='cs' ? 'selected' : null }}>CS</option>
                <option value="teknisi" {{ old('role', $user->role)=='teknisi' ? 'selected' : null }}>Teknisi</option>
          ...
          <div class="col-md-6">
            <div class="form-group mb-3">
              ...
              <div class="input-group input-group-merge">
                ...
                <input type="text" class="form-control" placeholder="masukan nomor telepon" id="telp" name="telp" value="{{ old('telp', $user->telp) }}"/>
              </div>
            </div>
          </div>
        </div>
