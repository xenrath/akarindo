          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukan nama level"
                  value="{{ old('nama', $level->nama) }}">
              </div>
            </div>
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="lama" name="lama"
                  placeholder="Masukan lama perbaikan" value="{{ old('lama', $level->lama) }}">
              </div>
            </div>
          </div>
        </div>
