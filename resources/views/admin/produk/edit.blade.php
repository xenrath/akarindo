        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <select class="form-control select2bs4" id="client_id" name="client_id">
              ...
              <option value="{{ $client->id }}" {{ old('client_id', $produk->client_id)==$client->id ? 'selected' : ''
                }}>{{ $client->nama }}</option>
              @endforeach
            </select>
          </div>
          <div class="form-group">
            ...
            <select class="form-control select2bs4" id="sublayanan_id" name="sublayanan_id">
              ...
              <option value="{{ $sublayanan->id }}" {{ old('sublayanan_id', $produk->sublayanan_id)==$sublayanan->id ?
                'selected' : '' }}>{{
