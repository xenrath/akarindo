...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="card">
    <div class="card-header d-flex align-items-start justify-content-between">
      <h5>Data Produk</h5>
      <a href="{{ url('admin/produk/create') }}" class="btn btn-sm rounded-pill btn-primary">
          ...
          <tbody class="table-border-bottom-0">
            ...
            <tr>
              ...
              <td class="text-center">
                <a href="{{ url('admin/produk/' . $produk->id) }}" class="btn rounded-pill btn-info btn-sm text-white">
