...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="card">
    <h5 class="card-header d-flex align-items-start justify-content-between">
      Data User
      <a href="{{ url('admin/layanan/create') }}" class="btn btn-sm rounded-pill btn-primary">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center">
              <a href="{{ url('admin/layanan/' . $layanan->id) }}" class="btn rounded-pill btn-info btn-sm text-white">
                <i class="tf-icons bx bx-show"></i>
              </a>
              <a href="{{ url('admin/layanan/' . $layanan->id . '/edit') }}"
                ...
                <div class="modal-dialog modal-dialog-centered modal-sm">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <form action="{{ url('admin/layanan/' . $layanan->id) }}" method="POST" id="delete{{ $layanan->id }}">
                        @csrf
                        @method('delete')
                      </form>
                    </div>
