            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="layanan" name="layanan" placeholder="Masukan layanan"
                  ...
                  <select class="custom-select form-control" id="level_id" name="level_id">
                    ...
                    @foreach ($levels as $level)
                      <option value="{{ $level->id }}"
                        {{ old('level_id', $layanan->level_id) == $level->id ? 'selected' : '' }}>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="keterangan" name="keterangan" rows="3" placeholder="Masukan keterangan">{{ old('keterangan', $layanan->keterangan) }}</textarea>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
