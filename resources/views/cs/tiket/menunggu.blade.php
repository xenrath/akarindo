                      ...
                      <form action="{{ url('cs/tiket/konfirmasi_jawab/' . $tiket->id) }}" method="POST">
                        ...
                        <div class="modal-body">
                          <div class="form-group">
                            ...
                            <textarea class="form-control" id="jawaban" name="jawaban" rows="3" placeholder="Masukan jawaban"></textarea>
                          </div>
                        </div>
                        <div class="modal-footer">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <form action="{{ url('cs/tiket/konfirmasi_alihkan/' . $tiket->id) }}" method="POST">
                        ...
                        <div class="modal-body">
                          @php
                            $teknisis = \App\Models\User::where('layanan_id', $tiket->produk->sublayanan->layanan_id)
                                ->withCount('tiket_teknisis')
                                ->orderBy('tiket_teknisis_count')
                                ->get();
                          @endphp
                          <div class="form-group">
                            ...
                            <select class="form-control select2bs4" id="teknisi_id" name="teknisi_id">
                              ...
                              @foreach ($teknisis as $teknisi)
                                <option value="{{ $teknisi->id }}"
                                  {{ old('teknisi_id') == $teknisi->id ? 'selected' : '' }}>{{ $teknisi->nama }}
                                  ({{ $teknisi->tiket_teknisis_count }})</option>
                              @endforeach
                            </select>
                          </div>
                        </div>
