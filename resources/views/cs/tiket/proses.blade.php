          ...
          <tbody class="table-border-bottom-0">
            ...
            <tr>
              ...
              <td>
                ...
                $expired = date('d-m-Y', strtotime($tiket->tanggal_awal . ' + 7 day'));
                @endphp
                @if ($now > $expired)
                <button type="submit" class="btn rounded-pill btn-primary btn-sm" data-bs-toggle="modal"
              ...
              <div class="modal-dialog modal-dialog-centered modal-sm">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    ...
                    <a href="{{ url('cs/tiket/konfirmasi/' . $tiket->id) }}" class="btn btn-primary">Ya</a>
                  </div>
                </div>
              </div>
            </div>
